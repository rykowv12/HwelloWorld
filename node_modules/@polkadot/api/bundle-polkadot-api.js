const polkadotApi = (function (exports, keyring, util, types, utilCrypto) {
  ...
  var _callCache$1 = /*#__PURE__*/_classPrivateFieldKey("callCache");
  ...
  var _send$1 = /*#__PURE__*/_classPrivateFieldKey("send");
  ...
  ***************************************************************************** */
  ...
  function queryElections(api) {
    ...
    return (elections ? api.queryMulti([api.query[council].members, api.query[elections].candidates, api.query[elections].members, api.query[elections].runnersUp]) : combineLatest([api.query[council].members(), of([]), of([]), of([])])).pipe(map(([councilMembers, candidates, members, runnersUp]) => ({ ...(elections ? {
      ...
      constructor(registry, extrinsic) {
        ...
        Object.defineProperty(this, _signViaSigner, {
          ...
          value: async (address, options, header) => {
            ...
            const payload = this.registry.createType('SignerPayload', util.objectSpread({}, options, {
              address,
  ...
  function augmentObject(prefix, src, dst, fromEmpty = false) {
    fromEmpty && util.objectClear(dst); // NOTE: This part is slightly problematic since it will get the
